...
from src.hardware_cost_model.umr_router import umr_score

# ================================================================
# Paths
# ================================================================
EVAL_PARQUET = "/home/ahasan/projects/hardware-aware-router/data/prompts/mixed_prompts_eval.parquet"
EVAL_CSV = "/home/ahasan/projects/hardware-aware-router/data/evaluation_dataset_processed_full.csv"
OUTPUT_CSV = "/home/ahasan/projects/hardware-aware-router/data/evaluation_dataset_processed_full_with_umr.csv"
