...
WORK_DIR = "/home/ahasan/projects/hardware-aware-router/umr_artifacts"

TRAIN_CSV = "/home/ahasan/projects/hardware-aware-router/data/UMR_router_training_data.csv"
...
def main():
    ...
    if args.cmd == "train":
        builder = UMRBuilder()
        builder.build(TRAIN_CSV, WORK_DIR)

    elif args.cmd == "score":
        q, c = umr_score(args.prompt, args.model)
